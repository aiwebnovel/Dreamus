...
const brandItems = [
  {
    ...
    드리머스는 드리머스, 드리머스 두가지의 뜻을 가지고 있습니다.
    드리머스 : 우리의 재능을 선한 사업을 위해, 미래의 꿈 자람을 위해 아낌없이 드린다.
  ...
  },
  {
    ...
    그리고 우리 아이들은, 단단한 마음근력을 가진 진정한 리더로 성장합니다.
  ...
  },
  {
    ...
    누군가 그 별을 꺼내주길 기다리고 있는 아이들에게 드리머스는 작은 반딧불이 되고자 합니다. 
    꿈노리 별노리는 영상과 교구대여, 자원봉사자인 꿈별 서포터즈가 함께하는 드리머스 만의 사회공헌 활동입니다.
    `,
  },
]
